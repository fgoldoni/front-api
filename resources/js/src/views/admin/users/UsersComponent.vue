                ...
                <div class="mb-4 md:mb-0 mr-4 ag-grid-table-actions-left">
                    <vs-dropdown vs-trigger-click class="cursor-pointer">
                        <div class="p-4 border border-solid d-theme-border-grey-light rounded-full d-theme-dark-bg cursor-pointer flex items-center justify-between font-medium">
                            <span class="mr-2">{{ currentPage * paginationPageSize - (paginationPageSize - 1) }} - {{ users.length - currentPage * paginationPageSize > 0 ? currentPage * paginationPageSize : users.length }} of {{ users.length }}</span>
...
<script>
  ...
  import config from "@/views/admin/users/tables/config"
  ...
  export default {
    ...
    mounted() {
      ...
      this.$events.$on('sidebar-data', data => this.setSidebarData(data))
      this.$events.$on('toggle-data-sidebar', toggle => this.toggleDataSidebar(toggle))
    }
  }
